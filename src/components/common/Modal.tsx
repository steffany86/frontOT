...
const Modal = ({ open, title, children, onClose, actions, containerClassName }: ModalProps) => {
  useEffect(() => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] overflow-y-auto bg-slate-900/45 backdrop-blur-sm">
      <div className="flex min-h-full items-start justify-center p-4 sm:items-center sm:p-6">
        <div className={`bento-modal max-h-[calc(100dvh-2rem)] overflow-auto ${containerClassName ?? 'max-w-lg'}`}>
